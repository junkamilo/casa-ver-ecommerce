    ...
    <section className="py-10 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="w-full md:flex-1 text-center">
          <h2 className="text-xl sm:text-2xl font-bold tracking-wider text-foreground mb-3 sm:mb-4">ELEVA TU LOOK</h2>
          ...
          <a
            href="#"
            className="inline-block bg-foreground text-primary-foreground text-sm font-semibold tracking-wider px-8 sm:px-10 py-3 hover:opacity-80 transition-opacity"
          >
            SHOP NOW
          </a>
