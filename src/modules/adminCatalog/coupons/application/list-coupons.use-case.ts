...
import { couponListQuerySchema } from "../contracts/coupon.schema";
...
export async function listCouponsUseCase(input: unknown) {
  ...
  return couponRepository.listCoupons(query);
}
