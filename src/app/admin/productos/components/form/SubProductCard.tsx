...
import { SubProductCardProps } from "../../types";
import { PRESET_COLORS, SIZES, fieldClsGold } from "../../constants";
        ...
        <div className="p-5 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              disabled={disabled}
              className={`${fieldClsGold()} resize-none`}
            />
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  min="0"
                  disabled={disabled}
                  className={fieldClsGold(!!errors.price)}
                />
